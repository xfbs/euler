...
TESTS() {
  ...
  RUN(test_math_lcm);
  RUN(test_math_gcd);
  RUN(test_math_factorial);
  RUN(test_math_factorial_speed);
  RUN(test_math_factorial_overflow);
  RUN(test_math_divisor_sum);
  RUN(test_math_fibonacci);
  RUN(test_math_nth_pandigital);
  RUN(test_math_is_palindrome);
  RUN(test_shift_mod);
  RUN(test_mult_mod);
  RUN(test_pow_mod);
  RUN(test_sum_mod);
